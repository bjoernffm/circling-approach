        ...
        <svg width="104.492mm" height="166.065mm" viewBox="0 0 104.492 166.065" version="1.1" id="svg6132" xmlns="http://www.w3.org/2000/svg">
            <g>
                <g transform="translate(-97.702461,-16.518505)">
                    ...
                    <g transform="translate(48.94013,-61.543539)">
                        <path
                        ...
                        <AltitudeText x="88.225189" y="192.43329" altitude={altitude} />
                        <AltitudeText x="139.30057" y="102.50824" altitude={altitude} />

                        <TdzeText x="83.527054" y="131.0369" altitude={tdze} />

                        <CourseText x="131.85316" y="150.466" course={course} />
                        <CourseText x="97.810265" y="99.561417" course={course + 180} align="end" />
                        <CourseText x="-41.847809" y="211.38739" course={course + 45} align="center" rotationDeg="-45" />
                        ...
                        <TimerPath x="101.91964"  y="183.51461" text={`${breakoutTimer}s`} align="center" rotationDeg="-45" />
                        <TimerPath x="125.16243" y="127.61529" text={`${timeToLowerAltitude}s`} align="end" rotationDeg="-90" />
